    ...
    <div class="container">
        <div class="row py-3">
            ...
            <div class="col-lg-3 col-12 align-left">
                ...
                <ul class="list-inline footer-icons light-300">
                    <li class="list-inline-item m-0">
                        <a class="text-light" target="_blank" href="https://facebook.com/">
            ...
            <div class="col-lg-2 col-md-4 my-sm-0 mt-4">
                ...
                <ul class="list-unstyled text-light light-300" style="font-size: small;">
                    <li class="pb-2">
                        <a class="text-decoration-none text-light py-1" href="https://www.java.com/fr/">Java</a>
                    </li>
                    <li class="pb-2">
                    ...
                    <li class="pb-2">
                        <a class="text-decoration-none text-light py-1" href="https://www.djangoproject.com/">Django</a>
                    </li>
                    <li class="pb-2">
                        <a class="text-decoration-none text-light py-1" href="https://wordpress.com/">WordPress</a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-4 my-sm-0 mt-4">
